  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6  mb-12 fade-in-up animate-duration-700 animate-delay-300">
            ...
            imageSrc={KpirImg}
            title={t("KPiRTitle")}
            description={t("KPiRDescription")}
          />
                  <Card
            imageSrc={WomanContractImg}
            title={t("NoCostCalculationCardTitle")}
            description={t("NoCostCalculationCardDescription")}
          />
                  <Card
            imageSrc={BooksImg}
            title={t("TradeBooksCardTitle")}
            description={t("TradeBooksCardDescription")}
          />
        <Card
            imageSrc={Image}
            title={t("PayrollServiceCardTitle")}
            description={t("PayrollServiceCardDescription")}
          />
      </div>
